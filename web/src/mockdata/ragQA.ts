...
export const RAG_QA: RagQA[] = [
  ...
  },
  {
    ...
    answerParts: [
      "截至 2026-07-03，改裝群（D1 技術工程）已產出 4 筆報工日報，其中 2 筆高信心已核對、2 筆中信心待人工複核。已確認工時合計 7.0h",
      { citeId: 1 },
      "；另有 2 筆推估工時（陳○○ ~2h、張○○ 未填）待核對後併入",
      { citeId: 2 },
      "。系統自動彙整的統計表可下載試算表",
      { citeId: 3 },
      "。",
    ...
    citations: [
      {
        id: 1, kind: "ticket", ref: "T-001, T-002", title: "已核對 · 高信心",
        source: "技術工程群組",
        snippet: "T-001 王○○ 4.0h（升降機水平調校 2.5 + 斜坡板焊接 1.5）· T-002 林○○ 3.0h（水電整合）· 合計 7.0h",
      },
      {
        id: 2, kind: "ticket", ref: "T-003, T-004", title: "待核對 · 中信心",
        source: "技術工程群組",
