...
| LINE 對話分析 · pilot 版（web-based · 兩階段）| [`modules/conversation-analysis-pilot.md`](modules/conversation-analysis-pilot.md) | 🧪 **APPROVED v0.3**（2026-07-20）· 待進 M1 | Scope 從 v0.2 大改：**web-based · leverage 現有後台**（reuse auth/Shell/signoff pattern/warroom/notify）· **兩階段 pilot**（Stage 1 mock validation 1 月 + Stage 2 real client 3 月）· M1-M8 共 8 個 milestone · OQ-CVA-1..15 全裁定；Stage 1→2 gate=技術通+UI 好用+accuracy 不倒退；Stage 2→SaaS gate=污染率<20% AND ≥1 客戶願付 NT$5k/月 AND 正面 feedback；相關反思：[`對話分析功能-可行性反思-2026-07-20.md`](對話分析功能-可行性反思-2026-07-20.md) |
