...
| LINE 對話分析 · pilot 版 | [`modules/conversation-analysis-pilot.md`](modules/conversation-analysis-pilot.md) | 🚧 **M0 DRAFT v0.1**（2026-07-20）| Scope 用途 B pilot（手動接檔 → 出 PDF/Excel 報告）、非 SaaS；核心目標=收集真實對話**污染率** metric 為未來 SaaS 決策依據；M1-M5 約 7 人日；OQ-CVA-1..10 待裁定（1-4 pilot 本期、5-10 未來 SaaS pre-decision）；Tier 3 手動 trigger 已砍（6 個 abuse 場景）；相關反思：[`對話分析功能-可行性反思-2026-07-20.md`](對話分析功能-可行性反思-2026-07-20.md) |
